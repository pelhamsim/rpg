package space.game.rpg.character.classes.abilities.engineer;

import space.game.rpg.character.classes.abilities.ClassAbility;
import space.game.rpg.util.ExpanseConstants;

public class HackLifeSupport extends ClassAbility {
	private static final int CLASS_ID = ExpanseConstants.CLASS_ID_ENGINEER;
