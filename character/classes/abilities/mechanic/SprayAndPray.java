package space.game.rpg.character.classes.abilities.mechanic;

import space.game.rpg.character.classes.abilities.ClassAbility;
import space.game.rpg.util.ExpanseConstants;

public class SprayAndPray extends ClassAbility {
	private static final int CLASS_ID = ExpanseConstants.CLASS_ID_MECHANIC;
